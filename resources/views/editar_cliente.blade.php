    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="activity">
                <div class="title">
                <i class="uil uil-users-alt"></i>
                    <span class="text">Cadastro {{$cliente->nome}}</span>
                </div>
                ...
                <div>
                    <form action="/atualizar-cliente/{{ $cliente->id }}" method="POST">
                        ...
                        <input class="input-nome" type="text" name="nome" placeholder="Nome" value="{{ $cliente->nome }}">
                        <!-- <input type="number" name="cpf" placeholder="CPF" ngModel> -->
                        <input class="input-cpf" type="text" name="cpf" placeholder="CPF" minlength="14" maxlength="14" oninput="formatarCPF(this)" value="{{ $cliente->cpf }}">
                        <input class="input-email" type="email" name="email" placeholder="Email" value="{{ $cliente->email }}">
                        <button class="btn-atualizar">Atualizar Cliente</button>
                    </form>
                </div>
