            ...
            <div class="overview">
                ...
                <div class="boxes">
                    <div class="box box1">
                        ...
                        <?php
                            foreach ($fornecedores as $contagem)
                            {
                                $cont = $contagem->count();
                            }
                        ?>
            ...
            <div class="activity">
                ...
                <div>
                    <form action="/cadastro-cliente" method="POST">
                        ...
                        <input type="text" name="cpf" placeholder="CPF" minlength="14" maxlength="14" oninput="formatarCPF(this)">
                ...
                <div class="activity-data">
                    ...
                    <!-- <div class="data status">
                        ...
                        <span class="data-list">Ativo</span>
                        <span class="data-list">Ativo</span>
                        <span class="data-list">Ativo</span>
                        <span class="data-list">Ativo</span>
                        <span class="data-list">Ativo</span>
