        ...
        <div class="dash-content">
            <div class="activity">
                ...
                <div class="activity-data">
                    ...
                    <div class="data joined">
                        <span class="data-title">Atualização</span>
                        <?php
                        foreach ($cliente as $c) {
                            echo '<span class="data-list">' . $c['updated_at'] . '</span><br>';
                        }
                        ?>
                    </div>
                </div>
                ...
                <div class="activity-data">
                    ...
                    <div class="data joined">
                        ...
                        <?php
                        foreach ($fornecedor as $f) {
                            echo '<span class="data-list">' . $f['created_at'] . '</span><br>';
                        }
                        ?>
                    </div>
                    <div class="data joined">
                        ...
                        <?php
                        foreach ($fornecedor as $f) {
                            echo '<span class="data-list">' . $f['updated_at'] . '</span><br>';
                        }
                        ?>
                    </div>
                </div>
